...
export default function VisaAssistancePage() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#0B0B0F] via-[#0b1020] to-[#0B0B0F] text-white">
      {/* HERO SECTION (AdvancedBanner) */}
      <AdvancedBanner
        id="visa-hero"
        layout="split"
        theme="gradient"
        badge={{ text: "✅ Trusted, secure, student-first" }}
        eyebrow="Visa Assistance"
        title={<span>Visa Assistance for Studying Abroad</span>}
        description={
          <>
            IPD Education makes your student visa journey seamless—from documentation to approval—with expert guidance at every step.
          </>
        }
        media={{ type: 'image', src: '/illustrations/hero-visa.svg', alt: 'Visa assistance hero illustration' }}
        customCtas={
