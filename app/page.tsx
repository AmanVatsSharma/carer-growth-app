    ...
    <div className="relative w-full bg-gradient-to-br from-[#f8fafc] via-[#e0e7ef] to-[#f1f5f9] dark:from-[#181c24] dark:via-[#232a36] dark:to-[#1a202c]">
      ...
      <div className="relative w-full h-[600px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-yellow-900 via-yellow-800 to-yellow-700">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 w-full">
          <h1 className="text-white text-5xl md:text-7xl font-extrabold drop-shadow-2xl mb-6 animate-fade-in tracking-tight">
          ...
          <p className="text-white text-lg md:text-2xl font-semibold mb-8 max-w-2xl animate-fade-in delay-100 drop-shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in delay-200">
            <Button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-8 py-4 rounded-lg text-lg font-bold shadow-xl hover:scale-105 transition-transform duration-200 border-2 border-yellow-300">
              Explore Careers Abroad
            </Button>
            <Button className="bg-white text-yellow-800 px-8 py-4 rounded-lg text-lg font-bold shadow-xl border-2 border-yellow-500 hover:bg-yellow-50 hover:scale-105 transition-transform duration-200">
              Study Abroad Now
            </Button>
          </div>
        </div>
