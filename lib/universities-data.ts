...
// import type { University } from "@/prisma/generated"

// const prisma = new PrismaClient()

// // Export the Prisma type for use in components
// export type { University }
...
//   country?: string
//   exam?: string
//   services?: string // Comma-separated list e.g., "visaSupport,counselling"
//   sortBy?: string // e.g., "name_asc"
//   page?: number
//   limit?: number
// }

// export async function getUniversities(filter: UniversityFilter = {}) {
//   const { q, country, exam, services, sortBy, page = 1, limit = 10 } = filter
//   const where: any = {}
...
//   const totalCount = await prisma.university.count({ where })
...
// // Other functions like getUniversityBySlug, getAllCountries, etc.
// // would also be updated to use Prisma.
// // For example:
// export async function getAllCountries(): Promise<string[]> {
//   const universities = await prisma.university.findMany({
//     select: { country: true },
