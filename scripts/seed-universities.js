...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var universities, _i, universities_1, uni;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Clear old data (optional, comment if you don’t want to wipe)
                return [4 /*yield*/, prisma_1.prisma.university.deleteMany()
                    // Hardcoded seed data
                ];
                case 1:
                    // Clear old data (optional, comment if you don’t want to wipe)
                    ...
                    _a.label = 2;
                case 2:
                    if (!(_i < universities_1.length)) return [3 /*break*/, 5];
                    uni = universities_1[_i];
                    return [4 /*yield*/, prisma_1.prisma.university.create({ data: uni })];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
