...
export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-white px-4 py-5 w-full max-w-screen mx-0 md:px-8">
            <div className="sm:mx-auto sm:text-center w-full">
                <NavbarLogo />
            </div>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2025 IPD Education All rights reserved.
                </div>
